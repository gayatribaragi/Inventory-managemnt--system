...
class salesClass:
    def __init__(self, root):
        ...
        lbl_invoice=Label(self.root,text="bill no",font=("times new roman",15),bg="white").place(x=50,y=100)
        ...
        lbl_title2=Label(bill_Frame,text="Bill Area ",font=("goudy old style",20),bg="orange").pack(side=TOP,fill=X)
        ...
        self.bill_photo = Image.open(r"C:\Users\gayat\OneDrive\Desktop\pythonprojinvent\images\billing.webp")
        self.bill_photo = self.bill_photo.resize((390, 350))
