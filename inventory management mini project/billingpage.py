...
class billClass:
    def __init__(self, root):
        ...
        btn_logout = Button(self.root, text="Logout", font=("times new roman", 15, "bold"), bg="yellow",cursor="hand2").place(x=1150, y=10, height=47, width=170)
        ...
        txt_search=Entry(productFrame2,textvariable=self.var_search,font=("times new roman",15,"bold"),bg="lightyellow").place(x=130,y=47,width=150,height=22)
        ...
        txt_name = Entry(customerFrame, textvariable=self.var_cname, font=("times new roman", 13, "bold"),bg="lightyellow").place(x=80, y=35, width=180)
        lbl_contact = Label(customerFrame, text="Contact No", font=("times new roman", 15), bg="white").place(x=270,y=35)
        txt_contact = Entry(customerFrame, textvariable=self.var_contact, font=("times new roman", 13, "bold"),bg="lightyellow").place(x=380, y=35, width=140)
        ...
        self.lbl_instock = Label(add_cart_widget_Frame, text="inStock", font=("times new roman", 15), bg="white")
        self.lbl_instock.place(x=5, y=70)



        btn_clear_cart = Button(add_cart_widget_Frame, text="clear",command=self.clear_cart, font=("times new roman", 15,"bold"),bg="lightgrey",cursor="hand2").place(x=180, y=70,width=150,height=30)
        ...
        btitle=Label(bill_Frame,text="customer bills",font=("goudy old style",20,"bold"),bg="#f44336",fg="white").pack(side=TOP,fill=X)
        ...
        bill_MenuFrame.place(x=953, y=520, width=410, height=140)

        self.lbl_amnt=Label(bill_MenuFrame,text='bill Amount\n[0]',font=("goudy old style",15,"bold"),bg="#3f51b5",fg="white")
        self.lbl_amnt.place(x=2,y=5,width=120,height=70)

        self.lbl_discount = Label(bill_MenuFrame, text='discount \n[5%]', font=("goudy old style", 15, "bold"), bg="#8bc34a",fg="white")
        self.lbl_discount.place(x=124, y=5, width=120, height=70)

        self.lbl_net_pay = Label(bill_MenuFrame, text='net pay\n[0]', font=("goudy old style", 15, "bold"), bg="#607d8b",fg="white")
        self.lbl_net_pay.place(x=246, y=5, width=160, height=70)



        btn_clear_all = Button(bill_MenuFrame, text='clear all',command=self.clear_all,cursor="hand2", font=("goudy old style", 15, "bold"),bg="#8bc34a", fg="white")
        btn_clear_all.place(x=0, y=80, width=190, height=50)

        btn_generate = Button(bill_MenuFrame, text='generate/save bill',command=self.generate_bill,cursor="hand2", font=("goudy old style", 15, "bold"), bg="#607d8b",fg="white",bd=0,)
        btn_generate.place(x=200, y=80, width=190, height=50)
    #     ========footer==============
        footer=Label(self.root,text="IMS_Inventory Management System | Developed BY Gayatri",font=("times new roman",11,"bold"),bg="#4d636d",fg="white",cursor="hand2").pack(side=BOTTOM,fill=X)
    ...
    def add_update_cart(self):
        if self.var_pid.get()=='':
            ...
            for row in self.cart_list:
                ...
                index_+= 1
            if present=='yes':
                op=messagebox.askyesno('confirm',"product already present\n do you want to update or remove from the cartlist",parent=self.root)
                if op==True:
    ...
    def bill_updates(self):
        ...
        net_pay=self.bill_amnt-((self.bill_amnt*5)/100)
