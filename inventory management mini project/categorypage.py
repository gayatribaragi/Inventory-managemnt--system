...
# ==============title==================
        ...
        # =======images=====
        self.im1=Image.open(r"C:\Users\gayat\OneDrive\Desktop\pythonprojinvent\images\Inventory.jpg")
        ...
        self.im2 = Image.open(r"C:\Users\gayat\OneDrive\Desktop\pythonprojinvent\images\category.jpg")
    ...
    def add(self):
        ...
        try:
            if self.var_name.get() == "":
                messagebox.showerror("Error1","Category name Should be required",parent=self.root)
            else:
                cur.execute("Select * from category where name=?",(self.var_name.get(),))
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error2","This category already present ,try different",parent=self.root)
                else:
    ...
    def delete(self):
        ...
        try:
            if self.var_cat_id.get() == "":
                messagebox.showerror("Error1","Please Select category from the list",parent=self.root)
            else:
                cur.execute("Select * from category where cid=?",(self.var_cat_id.get(),))
                row=cur.fetchone()
                if row==None:
                    messagebox.showerror("Error2","please try again",parent=self.root)
                else:
